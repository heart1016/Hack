set statusline+=%#warningmsg#  "syntas 自动弹出错误   
...
func SetTitle() 
    ...
    elseif &filetype == 'ruby'
        ...
        call append(line(".")+1, "  > Author:Hack ") 
        call append(line(".")+2, "  > Mail:heart10162115@foxmail.com ") 
    ...
    if &filetype == 'c'
        ...
        call append(line(".")+9, "#include<strings.h>")
        call append(line(".")+10, "#include<errno.h>")
        call append(line(".")+11, "#include<ctype.h>")
        call append(line(".")+12, "#include<unistd.h>")
        call append(line(".")+13, "#include<fcntl.h>")
        call append(line(".")+14, "#include<sys/types.h>")
        call append(line(".")+15, "#include<sys/socket.h>")
        call append(line(".")+16, "#include<sys/stat.h>")
        call append(line(".")+17, "#include<arpa/inet.h>")
        call append(line(".")+18, "#include<sys/epoll.h>")
        call append(line(".")+19, "")
        call append(line(".")+20, "#define SERV_PORT 8000")
        call append(line(".")+21, "#define SERV_IP \"192.168.42.39\"")
        call append(line(".")+22, "#define MAXLINE 10")
        call append(line(".")+23, "")
